...
import {IRewardsController} from "@aave-v3-origin/src/periphery/contracts/rewards/interfaces/IRewardsController.sol";
...
contract Strategy is BaseStrategy, UniswapV2Swapper, KeeperCompatibleInterface {
    ...
    function _deployFunds(uint256 _amount) internal override {
        ...
        if (aaveAPY > compoundAPY) {
            ...
            // Deposit on Compound
            // demande à Axel si c'est la bonne manière de gère la réponse de retour de la fonction mint
    ...
    function _freeFunds(uint256 _amount) internal override {
        ...
        // Voir si on laisse ce bug, pour voir si les tests sont bien faits car on retire dans les deux pools
    ...
    function _claimAndSellRewards() internal {
        ...
        if (totalCollateralBase > 0) {
            //@axel Etre sure que cest des a token et si ce n'est pas le cas, voir si on peut le récupérer ou non.
            ...
            //@axel Autre finding, pas de possibilite de withdraw les tokens en cas de shutdown //
                ...
                for (uint256 i = 0; i < rewardsList.length; ++i) {
                    if (claimedAmounts[i] > 0) {
                        ...
                        if (rewardToken != address(asset)) {
                            //@axel Faire test d'intégration que la fct fonctionne bien.
        ...
        if (compoundBalance > 0) {
            ...
            //@axel s'assurer que la fct fonctionne bien (claimcomp permet de récupérer les rewards)
